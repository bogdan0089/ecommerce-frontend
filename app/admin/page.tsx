...
import { authFetch, createProduct, deleteProduct, moderateProduct, logout } from "@/lib/api";
...
type FilterStatus = "all" | "accept" | "pending" | "rejected";
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#080808", color: "#fff" }}>
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 100, backgroundColor: "rgba(8,8,8,0.96)", backdropFilter: "blur(16px)", borderBottom: "1px solid #141414", padding: "0 40px", height: "60px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <span style={{ color: "#333", fontSize: "11px", letterSpacing: "3px" }}>ADMIN PANEL</span>
        <button
      ...
      <main style={{ maxWidth: "1100px", margin: "0 auto", padding: "56px 40px" }}>

        {/* Header */}
        <div style={{ marginBottom: "40px" }}>
          <p style={{ color: "#444", fontSize: "11px", letterSpacing: "3px", marginBottom: "8px" }}>MANAGEMENT</p>
          <h1 style={{ fontSize: "40px", fontWeight: "800", letterSpacing: "-1px" }}>Products</h1>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1px", backgroundColor: "#141414", marginBottom: "40px", border: "1px solid #141414" }}>
          {(["all", "accept", "pending", "rejected"] as FilterStatus[]).map((s) => (
            <button
              key={s}
              onClick={() => setFilter(s)}
              style={{
            ...
            >
              ...
              <p style={{ color: s === "all" ? "#fff" : STATUS_COLOR[s], fontSize: "28px", fontWeight: "800" }}>{counts[s]}</p>
            </button>
          ))}
        </div>
        ...
        {showForm && (
          <form onSubmit={handleCreate} style={{ backgroundColor: "#0d0d0d", border: "1px solid #141414", padding: "28px", marginBottom: "32px", borderRadius: "2px" }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                  <input
                    ...
                    style={{ width: "40px", height: "38px", border: "1px solid #222", backgroundColor: "#0d0d0d", borderRadius: "2px", cursor: "pointer", padding: "2px" }}
                  />
                  <input
                    type="text"
                    value={form.color}
            ...
            <div style={{ marginTop: "20px", display: "flex", justifyContent: "flex-end" }}>
              <button
                type="submit"
                style={{ backgroundColor: "#fff", color: "#000", border: "none", padding: "11px 28px", cursor: "pointer", fontWeight: "800", fontSize: "11px", letterSpacing: "3px", borderRadius: "2px" }}
              >
                CREATE
              </button>
            </div>
        ...
        <div style={{ border: "1px solid #141414" }}>
          {/* Table header */}
          <div style={{ display: "grid", gridTemplateColumns: "48px 64px 1fr 100px 80px 110px 160px", gap: "0", borderBottom: "1px solid #141414", padding: "0 16px" }}>
          ...
          {visible.length === 0 && (
            <div style={{ textAlign: "center", padding: "48px", color: "#333", fontSize: "12px", letterSpacing: "3px" }}>
              NO PRODUCTS
            </div>
          )}
          ...
          {visible.map((product) => (
            <div
              key={product.id}
              style={{ display: "grid", gridTemplateColumns: "48px 64px 1fr 100px 80px 110px 160px", gap: "0", borderBottom: "1px solid #0f0f0f", padding: "0 16px", alignItems: "center" }}
            >
              <div style={{ padding: "14px 8px", color: "#333", fontSize: "12px" }}>#{product.id}</div>
              <div style={{ padding: "14px 8px" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "2px", overflow: "hidden", backgroundColor: "#141414", flexShrink: 0 }}>
                  {product.image_url ? (
              ...
              <div style={{ padding: "14px 8px", display: "flex", gap: "6px" }}>
                {product.status !== "accept" && (
                  <button
                    onClick={() => handleModerate(product.id, "accept")}
                ...
                {product.status !== "rejected" && (
                  <button
                    ...
                    style={{ backgroundColor: "#d9770615", color: "#d97706", border: "1px solid #d9770630", padding: "5px 10px", cursor: "pointer", fontSize: "10px", letterSpacing: "1px", borderRadius: "2px", fontWeight: "700" }}
                  >
                    REJECT
                  </button>
                )}
